---- MODULE TestIF_TTrace_1779886627 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("TestIF_TTrace_1779886627.json", _TETrace)
...
\*
\*trace == IODeserialize("TestIF_TTrace_1779886627.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG TestIF_TTrace_1779886627 ----
CONSTANTS
    Flag = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed May 27 20:57:08 CST 2026