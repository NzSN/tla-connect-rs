---- MODULE GenerateTraces_TTrace_1779886487 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("GenerateTraces_TTrace_1779886487.json", _TETrace)
...
\*
\*trace == IODeserialize("GenerateTraces_TTrace_1779886487.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG GenerateTraces_TTrace_1779886487 ----
CONSTANTS
    SpecExists = TRUE
    ApalacheResult = OK
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed May 27 20:54:47 CST 2026